<template>
  <div>
    <Content subline="Impressum">
      <p>
        ...
        Mitglied der WKÖ, WKOÖ<br>
        </p>

        <p>
        UID-Nr: ATU77825016<br>
        FN: 575396x<br>
        FB-Gericht: Landesgericht Linz<br>
        </p>
    ...
    <Content subline="Datenschutz">
      <h4>Verantwortlicher im Sinne der DSGVO</h4>
        ...
        <h4>Datenerhebung auf unserer Website</h4>
  ...
  <li>die von Ihnen aufgerufene(n) Internetseite(n) unseres Internetauftritts,</li>
  <li>Typ und Version des von Ihnen genutzten Internet-Browsers,</li>
  <li>das von Ihnen genutzte Betriebssystem,</li>
  <li>die Internetseite, von der Sie auf unseren Internetauftritt gewechselt haben (Referrer- URL),</li>
